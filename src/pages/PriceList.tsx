...
export function PriceList() {
  const { items, stores, source, cachedAt, isLoading, progress, error, refresh, updateStorePrice, fetchHistory } =
    useItemPrices()
  ...
  // Keep the open modal in sync with refreshed item data.
  useEffect(() => {
  ...
  const tableCols = 3 // Product · Cost · Prices action
      ...
      <div className="max-w-7xl mx-auto">
        <header className="mb-7 flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4">
          <div>
            ...
            <p className="text-sm text-base-content/45 mt-1">{sourceLabel} · cost is fixed per item · view & edit the price per branch</p>
